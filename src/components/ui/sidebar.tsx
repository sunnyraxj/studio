  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "h-full w-full flex flex-col bg-muted/40 border-r",
            className
          )}
          {...props}
        >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "[[data-side=left][data-state=expanded]_&]:cursor-w-resize [[data-side=right][data-state=expanded]_&]:cursor-w-resize",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-accent-foreground opacity-0",
        className
      )}
      {...props}
    />
